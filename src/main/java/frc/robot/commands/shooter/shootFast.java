...
import frc.robot.commands.vision.alignPID;
...
public class shootFast extends SequentialCommandGroup {
  /** Creates a new shoot. */
  public shootFast(ShooterSubsystem shooter, IntakeSubsystem intake, Angler angler, Vision vision) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        new alignPID(vision),
        new angle(angler).until(() -> angler.anglerReadyToShoot()),
        new runWheel(shooter).withTimeout(0.35)
      ),//.withTimeout(1.5),
