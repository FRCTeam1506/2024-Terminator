...
public class shootNoAngle extends SequentialCommandGroup {
  /** Creates a new shoot. */
  public shootNoAngle(ShooterSubsystem shooter, IntakeSubsystem intake, Angler angler, Vision vision) {
