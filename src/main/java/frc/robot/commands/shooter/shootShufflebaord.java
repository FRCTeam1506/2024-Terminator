...
public class shootShufflebaord extends SequentialCommandGroup {
  /** Creates a new shoot. */
  public shootShufflebaord(ShooterSubsystem shooter, IntakeSubsystem intake, Angler angler, Vision vision) {
    ...
    addCommands(
      new ParallelCommandGroup(
        ...
        new setPosition(angler, angler.getShuffleboardInput()),//.until(() -> angler.getPos() > angler.getVisionPosition()),
